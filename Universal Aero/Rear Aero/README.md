You can make your own airfoil profile depending on your needs using this [NACA 4 digit airfoil generator](http://airfoiltools.com/airfoil/naca4digit). You don't need to be an
